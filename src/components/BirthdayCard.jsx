      ...
      <AnimatePresence mode="wait">
        {!isOpen ? (
          <motion.div
            ...
            className="bg-white/30 backdrop-blur-md rounded-3xl p-12 shadow-2xl border border-white/50 flex flex-col items-center gap-6"
          >
            <motion.div
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
              Happy Birthday For Pornthip
            </h1>

            <div className="scale-75">
              <Cake onClick={handleOpen} />
            </div>
          </motion.div>
        ) : (
          <motion.div
